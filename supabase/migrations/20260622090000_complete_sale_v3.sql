-- ============================================================================
-- Milestone 1 (Tax & receipts) — Step 4: update complete_sale to use
-- generate_or_number() for gapless OR numbers and dual-write to sale_payments.
-- ============================================================================
...
begin
  ...
  -- Generate gapless OR number (BIR-compliant sequential numbering).
  -- BIR CAS accreditation required before these are legally valid ORs.
  ...
  -- Dual-write to sale_payments for multi-tender foundation.
