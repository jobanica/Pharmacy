    ...
    await Promise.all([
      ...
      fetchAllRows((from, to) =>
        supabase
          .from("products")
          .select(
            "id, name, generic_name, category_id, sku, barcode, unit, requires_prescription, reorder_point, default_price_centavos, default_cost_centavos, is_active, categories(name)",
          )
